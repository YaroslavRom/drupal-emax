...
class __TwigTemplate_aca774bf5bfbefda9144e2a48dc05ae61effa8b6adb6e6413c6057ddb6182345 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["delta"] ?? null), 20, $this->source))];
    ...
    ";
        // line 25
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["item"] ?? null), 25, $this->source), "html", null, true));
        echo "
  </div>
";
    }
...
{% endblock %}
", "modules/slick/templates/slick-vanilla.html.twig", "/var/www/web/modules/slick/templates/slick-vanilla.html.twig");
    }
